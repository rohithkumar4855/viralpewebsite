  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 font-sans text-gray-800">
      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 flex flex-col gap-6 w-full max-w-[720px]">
          ...
          <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100 flex flex-col md:flex-row justify-between items-center gap-6 max-w-[721px]   md:max-h-[418px]">
            <div className='flex flex-col'>
              <div className='flex  flex-row '>
                <div className="flex-1 space-y-4 max-w-md flex-row justify-between">
                  <p className="text-xs font-semibold text-gray-500 w-[157px] h-[24px] pt-[23px] ">Refer & Earn with ViralPe</p>
                  <h1 className="text-xl md:text-xl font-extrabold text-gray-900 ">
                    Refer Your Friends & <br />
                    Earn <span className="text-[#800020]">Exciting </span>Rewards!
                  </h1>
                ...
                {/* Illustration Area */}
                <div className="  w-full md:w-[318px]  h-full md:h-[384px]    ">
