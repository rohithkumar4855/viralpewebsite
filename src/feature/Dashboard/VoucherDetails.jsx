...
import Fashion from "/images/nike.png";
import Footwear from "/images/nike.png";
import Accessories from "/images/nike.png";
import cashbackicon from "/images/nike.png";
import { Zap, Lock, Headphones, ShieldCheck, Star } from 'lucide-react';
// import "bootstrap-icons/font/bootstrap-icons.css";
import Myntra from "../../../public/images/nike.png";
 ...
 const categories = [
  {
    ...
    para:
      voucher?.brand === "Nike"
        ...
        : "Get instant cashback on your Myntra purchases when you pay using this ViralPe voucher."
  }
];
  ...
  const voucherData = [
    { id: 1, brand: 'Myntra', logo: Myntra, tag: 'Get ₹50 Cashback', isPromo: true, category: 'Fashion', price: 200, discount: 5 },
    { id: 2, brand: 'Starbucks', logo: Myntra, tag: '5% Cashback', isPromo: false, category: 'Food', price: 150, discount: 5 },
    { id: 3, brand: 'Starbucks', logo: Myntra, tag: '5% Cashback', isPromo: false, category: 'Food', price: 150, discount: 5 },
    { id: 4, brand: 'Starbucks', logo: Myntra, tag: '5% Cashback', isPromo: false, category: 'Food', price: 150, discount: 5 },
    { id: 5, brand: 'Starbucks', logo: Myntra, tag: '5% Cashback', isPromo: false, category: 'Food', price: 150, discount: 5 },
    ...
    const steps = [
      {
        ...
        icon: (
          <svg className="w-10 h-10 text-rose-800" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125v-9.75A1.125 1.125 0 0 1 4.875 9.75H8.25M16.5 4.5h-2.25a3 3 0 0 0-3 3v2.25m3-5.25h3.75a1.125 1.125 0 0 1 1.125 1.125v9.75a1.125 1.125 0 0 1-1.125 1.125h-3.75A1.125 1.125 0 0 1 13.5 15.75V12c0-.621.504-1.125 1.125-1.125h3.75m-6-6.75a3 3 0 0 0-3-3h-2.25a3 3 0 0 0-3 3v2.25" />
          </svg>
        )
      },
      {
      ...
      },
      {
        ...
        icon: (
          <svg className="w-10 h-10 text-rose-800" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 14.25l6-6m4.5-3.493V21a.75.75 0 01-1.125.65l-4.125-2.357-4.125 2.357A.75.75 0 013.75 21V4.757c0-.527.167-1.045.476-1.473l2.25-3.125A1.5 1.5 0 017.693 0h8.614a1.5 1.5 0 011.217.618l2.25 3.125c.309.428.476.946.476 1.473zM9.375 9a.375.375 0 11-.75 0 .375.375 0 01.75 0zm6 6a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
          </svg>
        )
      },
      {
    ...
    const stats = [
      {
        ...
        label: "Bought Today",
        icon: (
          <svg className="w-8 h-8 text-rose-800" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 14.25l6-6m4.5-3.493V21a.75.75 0 01-1.125.65l-4.125-2.357-4.125 2.357A.75.75 0 013.75 21V4.757c0-.527.167-1.045.476-1.473l2.25-3.125A1.5 1.5 0 017.693 0h8.614a1.5 1.5 0 011.217.618l2.25 3.125c.309.428.476.946.476 1.473zM9.375 9a.375.375 0 11-.75 0 .375.375 0 01.75 0zm6 6a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
          </svg>
        )
      },
      {
        ...
        icon: (
          <svg className="w-8 h-8 text-rose-800" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499c.172-.435.744-.435.916 0l2.115 5.342a1 1 0 00.754.646l5.746.582c.476.048.667.63.322.966l-4.34 4.236a1 1 0 00-.287.886l1.205 5.679c.1.473-.404.84-.817.576l-4.996-3.232a1 1 0 00-1.077 0l-4.996 3.232c-.413.264-.917-.103-.817-.576l1.205-5.679a1 1 0 00-.287-.886L1.87 11.034c-.345-.336-.154-.918.322-.966l5.746-.582a1 1 0 00.754-.646l2.115-5.342z" />
          </svg>
        )
      },
      {
      ...
      <div className="max-w-[1240px] pt-36  mx-auto">
        ...
        <div className="grid grid-cols-12 gap-6 items-start">
          ...
          <div className="col-span-12 lg:col-span-8 flex flex-col gap-6">
            ...
            <div className="w-full max-w-3xl bg-white rounded-[24px] p-6 border border-gray-100 shadow-sm">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-4">
                ...
                {vouchersData.map((voucher) => {
                  ...
                  return (
                    <div
                      key={voucher.id}
                      className="w-full h-[123px] bg-white border border-[#9c27b0]/20 rounded-[24px] shadow-sm flex flex-col items-center justify-between p-2.5 transition-all duration-200 hover:shadow-md mx-auto"
                    >
            ...
            {/* Alert Banner */}
            <div className="w-full max-w-3xl bg-emerald-50 rounded-2xl flex p-4 items-center gap-3">
              <img src={cashbackicon} alt='cashbackicon' className='w-12 h-12 object-contain shrink-0' />
            ...
            {/* How It Works Grid */}
             <div className=" w-full md:w-[700px] md:h-[229px] bg-white rounded-[24px] p-6 border border-gray-100 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-4 items-start relative">
                  {steps.map((step, index) => (
                    <div key={step.id} className=" flex flex-col items-center text-center relative group ">
                      ...
                      {/* Icon Wrapper Box */}
                      <div className=" flex items-center justify-center  border border-rose-100 rounded-2xl p-4 shadow-sm mb-2 transform transition-transform duration-300 group-hover:scale-105">
                        {step.icon}
                      </div>

                      {/* Title */}
                      <h3 className="text-s font-bold text-gray-800 mb-2 tracking-wide">
                        {step.title}
                      </h3>
          ...
          <div className="col-span-12 lg:col-span-4 flex flex-col gap-6">
                      ...
                      <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm lg:top-6">
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 font-sans">
                          {/* Title */}
                          <h2 className="text-[22px] font-bold text-gray-900 mb-5">Order Summary</h2>
          
                          {/* Main Brand and Total Header */}
                          <div className="flex justify-between items-center mb-4">
                            <div className="flex items-center gap-3">
                              <div className="w-11 h-11 bg-gradient-to-br from-pink-500 to-orange-400 rounded-lg flex items-center justify-center shadow-sm">
                          ...
                          <div className="flex justify-between items-center text-[13px] text-gray-500 font-medium px-1">
                            <div className="flex items-center gap-1.5">
                              <span className="text-red-500 text-xs">🛡️</span> 100% Secure Payments
                            </div>
                            <div className="flex items-center gap-1.5">
                              <span className="text-red-500 text-sm">⚡</span> Instant Code Delivery
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="w-full md:max:w-[494px] h-full max:h-[126px] bg-white border border-gray-100 rounded-2xl flex gap-2">
                        <div className="mx-auto px-4 py-6 font-sans">
                          <div className="">
                            <div className="grid grid-cols-3 md:grid-cols-3 gap-8 md:gap-0 items-center">
          
                              {stats.map((item, index) => (
                                <div
                                  key={item.id}
                                  className={`flex flex-col items-center text-center relative ${index !== stats.length - 1 ? 'md:border-r md:border-gray-200' : ''}`}
                                >
                                  <div className="mb-4 flex items-center justify-center p-2 rounded-xl">
                                    {item.icon}
                                  </div>
                                  <h2 className="text-l md:text-xl font-extrabold text-gray-900 tracking-tight mb-1">
                                    {item.value}
                                  </h2>
                                  <p className="text-gray-500 font-normal text-l md:text-lg">
                                    {item.label}
                                  </p>
                                </div>
                              ))}
        ...
        <div className="mt-12 bg-white rounded-[24px] p-6 border border-gray-100 shadow-sm w-full max-w-[1240px]">
          <div className='flex justify-between items-center mb-6'>
            <h1 className='text-2xl font-bold text-gray-900'>You May Also Like</h1>
            {/* FIXED: Changed typo classname to className */}
            <button className="text-red-600 font-semibold flex items-center gap-1 hover:text-red-700 transition-colors">
          ...
          <div className="w-full flex items-center gap-4 justify-center">
            ...
            <button
              ...
              className={`w-9 h-9 rounded-full border flex items-center justify-center text-sm font-bold transition-all shrink-0 shadow-sm
                ${currentIndex === 0
            ...
            <div className="max-w-[916px] w-full overflow-hidden px-0.5 py-1">
                ...
                {voucherData.map((voucher) => (
                  ...
                  >
                    ...
                    <div className="w-full flex items-center justify-between mt-auto">
                      ...
                      <span className="text-[10px] font-semibold text-gray-400">12K+ Bought</span>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className='w-full max-w-[1240px] flex flex-col md:flex-row border border-red-100 gap-6 items-start md:items-center justify-around mt-8 p-6 bg-[#FFEDEE] rounded-2xl shadow-xs'>
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div>
              ...
              <p className="text-[11px] font-medium text-gray-400 mt-0.5">Active daily consumers</p>
            </div>
          </div>
        </div>
