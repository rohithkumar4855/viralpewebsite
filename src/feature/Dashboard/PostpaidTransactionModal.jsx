...
const PostpaidTransactionModal = ({ transaction, onClose }) => {
    return (
<div className="w-[645px] h-[953px] overflow-y-auto flex flex-col bg-white rounded-[20px] shadow-xl border border-gray-200 p-6 font-sans text-gray-900 mx-auto cursor-auto">            {/* Header */}
            <div className="flex justify-between items-center mb-6 mt-7 shrink-0">
                <h2 className="text-[22px] font-bold tracking-tight">Transaction Details</h2>
                <button
                    onClick={onClose}
            ...
            <div className="flex justify-between items-center p-4 border border-gray-200 rounded-2xl mb-4 shrink-0">
                <div className="flex gap-4 items-center">
                    <div className="bg-[#fcf3f3] w-12 h-12 rounded-xl flex items-center justify-center shrink-0">
                        {/* Battery/Phone Icon */}
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#a03040" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div>
                        <h3 className="font-bold text-[15px]">Payment Successful</h3>
            ...
            <div className="border border-gray-200 rounded-2xl p-4 mb-4  shrink-0">
                <h3 className="font-bold text-[15px] mb-4">Payment Summary</h3>
                <div className="flex items-center justify-between">

                    {/* Left: Balance Before */}
                    <div className="text-left">
                        <p className="font-bold text-[14px]">₹1175.00</p>
                        <p className="text-[10px] text-gray-500 mt-0.5">Wallet Balance Before</p>
                    </div>

                    {/* Center: Paid Amount & Dotted Arrow */}
                    <div className="flex-1 flex flex-col items-center justify-center px-4 relative">
                        <p className="font-bold text-[13px] mb-0.5">₹250.00</p>
                        <p className="text-[9px] text-gray-400 mb-1.5">Paid From Wallet</p>
                        <div className="w-full flex items-center">
                            <div className="flex-1 border-b border-dashed border-[#a03040]"></div>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#a03040" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="-ml-1">
                    ...
                    {/* Right: Balance After */}
                    <div className="text-right">
                        <p className="font-bold text-[14px] text-[#a03040]">₹925.00</p>
                        <p className="text-[10px] text-gray-500 mt-0.5">Wallet Balance After</p>
                    </div>
            ...
            <div className="border border-gray-200 rounded-2xl p-4 mb-8 shrink-0">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center text-[13px]">
                        ...
                        <span className="font-semibold text-right">Cashback Received</span>
                    </div>
                    <div className="flex justify-between items-center text-[13px]">
                    ...
                    <div className="flex justify-between items-center text-[13px]">
                        ...
                        <span className="font-bold text-[#a03040] text-right">
                            {transaction?.amount || '- ₹199.00'}
                        </span>
                    </div>
                    <div className="flex justify-between items-center text-[13px]">
...
export default PostpaidTransactionModal;